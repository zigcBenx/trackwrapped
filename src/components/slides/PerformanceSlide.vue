<template>
  ...
  >
    ...
    <div v-else class="reveal-container">
      ...
      <h1 class="slide-title">Performance Trend</h1>
      <div class="massive-stat">
        <div class="stat-value-massive">{{ isImproving ? 'UP' : 'STEADY' }}</div>
        <div class="stat-label-massive">TREND</div>
        <div class="stat-subtext">{{ isImproving ? 'Personal Bests Incoming!' : 'Consistency is King' }}</div>
      </div>
    </div>
  </SlideWrapper>
</template>
