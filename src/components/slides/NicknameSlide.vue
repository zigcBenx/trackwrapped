<template>
  ...
  >
    ...
    <div v-else class="reveal-container">
      ...
      <h1 class="slide-title">Your Nickname</h1>
      <div class="massive-stat">
        <div class="stat-value-massive">{{ nickname }}</div>
        <div class="stat-label-massive">EARNED TITLE</div>
      </div>
    </div>
  </SlideWrapper>
</template>
...
const sequence = ["Based on your stats...", "We found the perfect title..."]
